...
external interface ObjectConstructor {
    ...
    fun create(o: Any?, properties: PropertyDescriptorMap /* dukat.PropertyDescriptorMap & dukat.ThisType<Any> */): Any
    fun defineProperty(o: Any, p: String, attributes: PropertyDescriptor /* dukat.PropertyDescriptor & dukat.ThisType<Any> */): Any
    fun defineProperty(o: Any, p: Number, attributes: PropertyDescriptor /* dukat.PropertyDescriptor & dukat.ThisType<Any> */): Any
    fun defineProperty(o: Any, p: Any, attributes: PropertyDescriptor /* dukat.PropertyDescriptor & dukat.ThisType<Any> */): Any
    fun defineProperties(o: Any, properties: PropertyDescriptorMap /* dukat.PropertyDescriptorMap & dukat.ThisType<Any> */): Any
    fun <T> seal(o: T): T
