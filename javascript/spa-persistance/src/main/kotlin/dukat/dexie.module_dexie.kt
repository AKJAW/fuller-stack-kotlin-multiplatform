...
external interface `T$2` {
    @nativeGetter
    operator fun get(name: String): Table<Any, dynamic /* String | Number | Date | ArrayBuffer | ArrayBufferView | DataView | Array<Array<Unit>> | dukat.IndexableTypeArrayReadonly */>?
    @nativeSetter
    operator fun set(name: String, value: Table<Any, dynamic /* String | Number | Date | ArrayBuffer | ArrayBufferView | DataView | Array<Array<Unit>> | dukat.IndexableTypeArrayReadonly */>)
}
...
external interface DexieInterface : Database {
    ...
    var transaction: `T$8`
    var collection: `T$9`
//    interface dukat.Table<T, Key> : dukat._Table<T, Key>
//    interface dukat.Collection<T, Key> : dukat._Collection<T, Key>
}
