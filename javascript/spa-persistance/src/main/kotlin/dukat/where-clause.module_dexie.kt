...
external interface WhereClause<T, TKey> {
    ...
    fun anyOf(keys: Array<dynamic /* String | Number | Date | ArrayBuffer | ArrayBufferView | DataView | Array<Array<Unit>> | dukat.IndexableTypeArrayReadonly */>): Collection<T, TKey>
    fun anyOf(vararg keys: dynamic /* String | Number | Date | ArrayBuffer | ArrayBufferView | DataView | Array<Array<Unit>> | dukat.IndexableTypeArrayReadonly */): Collection<T, TKey>
    ...
    fun noneOf(keys: Array<dynamic /* String | Number | Date | ArrayBuffer | ArrayBufferView | DataView | Array<Array<Unit>> | dukat.IndexableTypeArrayReadonly */>): Collection<T, TKey>
...
external interface WhereClause__0 :
    WhereClause<Any, dynamic /* String | Number | Date | ArrayBuffer | ArrayBufferView | DataView | Array<Array<Unit>> | dukat.IndexableTypeArrayReadonly */>
